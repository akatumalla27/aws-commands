prefix ="CONTROLLER_"
let varnames = ["PENDINGSHEETSTARTCOL","PENDINGSHEETSTARTROW","SHEET","FORM","PENDING","MAINSHEET","inputDataRange","requiredDataRange","SHEETLINK","SEARCHCELL","SEARCH_COL_IDX_IN_MAIN","SEARCHCELLRANGE"]

var thisSheetVariables = {};
formName ="ControllerEntryForm"
pendingSheetName = "ControllerPending"
mainSheetName="Controller"
...
thisSheetVariables[(prefix+"inputDataRange")]= ["E11","E13","E15"];
thisSheetVariables[(prefix+"requiredDataRange")]=["E11","E13"];
thisSheetVariables[(prefix+"SHEETLINK")]="https://docs.google.com/spreadsheets/d/1v1KijjQavIgBgKirtdFkKCaulI9N-0Il1m60oZD162Q/edit#gid=1972816712";
...
function AddToControllerPendingSheet() {
  var inputValues =[]
